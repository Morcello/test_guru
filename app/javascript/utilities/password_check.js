...
function passwordCheck() {
  ...
  if (password.value == confirmation.value) {
    document.querySelector('.octicon-check').classList.remove('text-danger')
    document.querySelector('.octicon-check').classList.add('text-success')
    document.querySelector('.octicon-x').classList.remove('hide')
  } else {
    document.querySelector('.octicon-check').classList.remove('text-success')
    document.querySelector('.octicon-check').classList.add('text-danger')
    document.querySelector('.octicon-x').classList.remove('hide')
  }
